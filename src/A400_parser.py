...
def main():
    file_name = 'A400 Parts List PDF 526'
    t = pdfminer.high_level.extract_text('A400 resized.pdf') # Extracts the pdf into a block of text and saves it as a str var
    # print(t)
    t=t.split('\n') # Splits the whole block of text into a list of strings by splitting it where a space is
    for i in t:
        print(i)
